...
void connectController(ChessView& view, IChessController ** cont, int argc,
		char ** argv) {
	int p1;
	int p2;

	if (argc != 2) {
		(*cont) = new Controller(0, 0);
...
///@ingroup chessgui
void ChessGui_log_handler(const gchar *log_domain, GLogLevelFlags log_level,
