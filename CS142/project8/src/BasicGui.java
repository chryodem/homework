...
public class BasicGui{
    ...
    private JFrame f = new JFrame("Flash Card Program"); //create Frame and Frame name
...
//    private JButton btnCenter = new JButton("Center");
    ...
    private JMenu mnuPractice = new JMenu("Practice"); // Practice Menu entry
    ...
    public BasicGui(){
        ...
        mnuPractice.add(mnuItemAbout); // Create About line
